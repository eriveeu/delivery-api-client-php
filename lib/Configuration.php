...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://dev.greentohome.at/api/v1';
    ...
    {
        $report  = 'PHP SDK (GreenToHome) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://dev.greentohome.at/api/v1",
                "description" => "GTH DEV Server",
            ],
            [
                "url" => "https://stg.greentohome.at/api/v1",
                "description" => "GTH STG Server",
            ],
            [
                "url" => "https://www.greentohome.at/api/v1",
                "description" => "GTH PROD Server",
            ]
        ];
    }
